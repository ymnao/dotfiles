...
## 追跡先
<本 PR で fix せず別 issue/PR に回した finding を列挙。0 件なら「なし」とだけ書き、表は省略>
...
- override 内容: <根拠が `step 8 override` のときのみ必須、user 指示の要約。それ以外は「該当なし」>
...
| Draft 判定 | <normal / draft> — <step 4 / step 5 / step 8 override, 理由> |
