...
TrayTip "Dotfiles keyboard customization loaded", "AutoHotkey", "17"
...
#+r:: {
    TrayTip "Reloading...", "AutoHotkey", "17"
    Sleep 500
    Reload
}
...
#+p:: {
    Suspend
    if (A_IsSuspended) {
        TrayTip "Hotkeys suspended", "AutoHotkey", "19"
    } else {
        TrayTip "Hotkeys resumed", "AutoHotkey", "17"
    }
}
